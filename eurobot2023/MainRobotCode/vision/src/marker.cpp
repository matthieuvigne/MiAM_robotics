  ...
  Eigen::Matrix<double,6,6> const& cov_TWC)
{
  ...
  Eigen::Matrix<double,6,6> const J_TWM_wrt_TWC = common::leftSe3ProductJacobian(TWC, TCM);
  Eigen::Matrix<double,6,6> const J_TWM_wrt_TCM = common::rightSe3ProductJacobian(TWC, TCM);

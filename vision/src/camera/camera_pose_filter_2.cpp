...
#include <camera/camera_pose_filter_2.hpp>
...
CameraPoseFilter2::CameraPoseFilter2(Params const& params)
: team_                 (params.team),
...
Eigen::Vector3d CameraPoseFilter2::initializeWpc(common::Team team)
{
  Eigen::Vector3d WpC;
  switch(team)
  {
...
Eigen::Matrix4d CameraPoseFilter2::initializeCovariance(
...
Eigen::Quaterniond CameraPoseFilter2::getQrc(double azimuth_deg, double elevation_deg)
{
  /* Sign conventions:
   * 500  = -90°  (looks left)
   * 1500 =   0°  (looks front)
...
Eigen::Affine3d CameraPoseFilter2::getTWC() const
{
...
void CameraPoseFilter2::predict(double azimuth_deg)
{
...
CameraPoseFilter2::Params CameraPoseFilter2::Params::getDefaultParams(common::Team team)
{
  Params params;
  params.team = team;

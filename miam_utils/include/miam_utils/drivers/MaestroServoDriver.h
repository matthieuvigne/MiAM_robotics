...
/// \copyright GNU GPLv3
    ...
    class MaestroDriver
    {
        public:
            ...
            virtual bool init(std::string const& portName, int const& deviceID = 12);
            ...
            virtual void setPosition(int const& servo, double const& position);
            ...
            virtual void setSpeed(int const& servo, int const& speed);
        private:

...
{
int dummy;
/** Matrix of size: 23 x 5 (row major format)
 * 
 ...
 * 
 *  Matrix containing 22 reference/measurement vectors of size 5 for first 22 nodes.
 */
real_t y[ 110 ];
...
/** Matrix of size: 110 x 5 (row major format) */
real_t evGx[ 550 ];
...
/** Matrix of size: 88 x 5 (row major format) */
real_t evHx[ 440 ];
...
/** Matrix of size: 1265 x 2 (row major format) */
real_t E[ 2530 ];
...
/** Matrix of size: 44 x 5 (row major format) */
real_t H10[ 220 ];
...
/** Matrix of size: 88 x 44 (row major format) */
real_t A[ 3872 ];

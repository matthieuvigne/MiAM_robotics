...
#define REFERENCE_WHEEL_SPACING 85 // reference wheel spacing in mm, from wheel to center of robot
#define MAX_WHEEL_SPEED 400 // max wheel velocity in mm/s
#define MAX_WHEEL_ACCELERATION 400 // max wheel acceleration in mm/s

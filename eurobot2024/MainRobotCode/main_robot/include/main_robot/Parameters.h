    ...
    #define MAIN_ROBOT_PARAMETERS_H
        ...
        namespace main_robot{
            inline RobotParameters generateParams()
            {
                ...
                param.wheelSpacing = 106.0; ///< Wheel spacing from robot center, in mm - identified during open loop experiments.
                param.encoderWheelRadius = 26.25; ///< Radius of encoder wheels, in mm.
                param.encoderWheelSpacing = 125.0; ///< Encoder wheel spacing from robot center, in mm.
                ...
                param.linearKp = 0.0 * 3.5;
                param.linearKd = 0.0 * 0.01;
                param.linearKi = 0.0 * 0.0;
                param.transverseKp = 0.0 * 0.005;
                param.rotationKp = 0.0 * 7.0;
                param.rotationKd = 0.0 * 0.01;
                param.rotationKi = 0.0 * 0.0;

...
class DropCratesAction: public AbstractAction
{
public:
    DropCratesAction(RobotInterface *robot, ServoManager *servoManager, int const& zoneId):
        AbstractAction("Drop crates " + std::to_string(zoneId), robot),

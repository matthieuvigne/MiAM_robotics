#ifndef MAIN_ROBOT_STEAL_CRATES_ACTION_H
#define MAIN_ROBOT_STEAL_CRATES_ACTION_H

#include <string>
#include "main_robot/AbstractAction.h"
#include "main_robot/ServoManager.h"

class StealCratesAction: public AbstractAction
{
public:
    StealCratesAction(RobotInterface *robot, ServoManager *servoManager, int const& zoneId):
        AbstractAction("Steal crates " + std::to_string(zoneId), robot),
